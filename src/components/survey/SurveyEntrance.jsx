    ...
    <div id="intro" className="w-[100%] max-w-[1200px] mx-auto px-[25px] pt-[53px] m"
      ...
      <div className="mt-[23px] w-full">
        <p 
          ...
          style={{ color: '#5B4B43' }}
        >
          <span className="font-bold" style={{ color: "#0A476D", fontSize: "0.875rem" }}>סל רווחה מותאם תרבותית – </span><span className="font-bold" style={{ color: "#0A476D", fontSize: "0.875rem", fontWeight:'800' }}>למה כדאי?</span>
          <br />
